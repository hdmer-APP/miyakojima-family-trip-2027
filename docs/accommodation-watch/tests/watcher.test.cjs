...
const rows = getCurrentRows(config, [baseObservation, candidateObservation]);
...
const events = detectEvents(config, [baseObservation, candidateObservation], rows, '2026-08-14T00:00:00+08:00');
